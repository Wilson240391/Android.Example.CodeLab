...
@Composable
fun DetailScreen(newsData: New, scrollState: ScrollState, navController: NavController) {
    Scaffold(topBar = {
        ...
        Column(
            ...
            Row(
                ...
                InfoWithIcon(icon = Icons.Default.DateRange, info = NewsData.stringToDate(newsData.publishedAt).getTimeAgo())
            }
...
fun InfoWithIcon(icon: ImageVector, info: String) {
    Row {
        Icon(icon, contentDescription = "Author", modifier = Modifier.padding(end = 8.dp), colorResource(id = R.color.purple_200))
        Text(text = info)
    }
}
