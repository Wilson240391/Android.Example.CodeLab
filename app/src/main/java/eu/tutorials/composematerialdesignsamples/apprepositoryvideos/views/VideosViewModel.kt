...
import eu.tutorials.composematerialdesignsamples.apprepositoryvideos.repository.getDatabase
...
class VideosViewModel(application: Application) : AndroidViewModel(application) {
    ...
    init {
        refrshDataFromRepository()
    }

    private fun refrshDataFromRepository(){
        viewModelScope.launch {
            try {
                ...
                //show a Toast error message and hide he progress bar
