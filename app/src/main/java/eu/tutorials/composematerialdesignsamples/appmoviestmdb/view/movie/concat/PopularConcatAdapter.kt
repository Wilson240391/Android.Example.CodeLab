...
import eu.tutorials.composematerialdesignsamples.databinding.TmdbMoviePopularRowBinding

class PopularConcatAdapter(private val moviesAdapter: MoviesAdapter): RecyclerView.Adapter<BaseConcatHolder<*>>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseConcatHolder<*> {
        val itemBinding = TmdbMoviePopularRowBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    private inner class ConcatViewHolder(val binding: TmdbMoviePopularRowBinding) : BaseConcatHolder<MoviesAdapter>(binding.root) {
