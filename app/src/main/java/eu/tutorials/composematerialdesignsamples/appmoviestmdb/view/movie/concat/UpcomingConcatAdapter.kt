...
import eu.tutorials.composematerialdesignsamples.databinding.TmdbMovieUpcomingRowBinding

class UpcomingConcatAdapter(private val moviesAdapter: MoviesAdapter): RecyclerView.Adapter<BaseConcatHolder<*>>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseConcatHolder<*> {
        val itemBinding = TmdbMovieUpcomingRowBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    private inner class ConcatViewHolder(val binding: TmdbMovieUpcomingRowBinding): BaseConcatHolder<MoviesAdapter>(binding.root){
